...
const String logoutUrl = 'https://fansvideo.us.auth0.com/v2/logout';
...
void launchLogoutURL(String currentUrl) async {
  var callbackUrl =
  currentUrl.substring(0, currentUrl.indexOf('/#'));
  String url =
      '$logoutUrl?client_id=$clientId&returnTo=$callbackUrl';
  if (await canLaunch(url)) {
    await launch(url, webOnlyWindowName: '_self');
  } else {
    throw 'Could not launch $url';
